...
import io.hashimati.domains.Vegetable;
import io.hashimati.services.VegetableService;
...
public class VegetableController {
    ...
    @Timed(value = "io.hashimati.controllers.vegetableController.save", percentiles = { 0.5, 0.95, 0.99 }, description = "Observing all service metric for saving vegetable object")
    ...
    @NewSpan("Vegetable-service")
    @Timed(value = "io.hashimati.controllers.vegetableController.findById", percentiles = { 0.5, 0.95, 0.99 }, description = "Observing all service metric for finding a vegetable object by id")
    ...
    @NewSpan("Vegetable-service")
    @Timed(value = "io.hashimati.controllers.vegetableController.deleteById", percentiles = { 0.5, 0.95, 0.99 }, description = "Observing all service metric for deleting a vegetable object by id")
    ...
    @NewSpan("Vegetable-service")
    @Timed(value = "io.hashimati.controllers.vegetableController.findAll", percentiles = { 0.5, 0.95, 0.99 }, description = "Observing all service metric for finding all vegetable objects")
    ...
    @NewSpan("Vegetable-service")
    @Timed(value = "io.hashimati.controllers.vegetableController.update", percentiles = { 0.5, 0.95, 0.99 }, description = "Observing all service metric for update a vegetable object")
    ...
    @Get("/findByName")
    @NewSpan("Vegetable-service")
    @Timed(value = "io.hashimati.controllers.vegetableController.findByName", percentiles = { 0.5, 0.95, 0.99 }, description = "Observing all service metric for finding a vegetable object by Name")
